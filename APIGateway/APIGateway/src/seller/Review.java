...
public class Review {
	...
	public Response addReview(HashMap<String, ?> reviewData) {
		...
		try {
	        ...
	        WebResource webResource = client
	          .resource("http://localhost:8090/SellerService/api/v2/review/sumbit");
	...
	public Response getAllReviews() {
		...
		try {
	        ...
	        WebResource webResource = client
	          .resource("http://localhost:8090/SellerService/api/v2/review/getreviews");
	...
	public Response getreviewById(@PathParam("reviewid") Integer reviewid) {
		...
		try {
	        ...
	        WebResource webResource = client
	          .resource("http://localhost:8090/SellerService/api/v2/review/getreview/"+reviewid);
	...
	public Response deleteById(@PathParam("reviewid") Integer reviewid) {
		...
		try {
	        ...
	        WebResource webResource = client
	          .resource("http://localhost:8090/SellerService/api/v2/review/deletebyid/"+reviewid);
	...
	public Response getReviewwithData(@PathParam("reviewid") Integer reviewid) {
		...
		try {
	        ...
	        WebResource webResource = client
	          .resource("http://localhost:8090/SellerService/api/v2/review/getreiewwithdata/"+reviewid);
	...
	public Response getReviewwithDataUser(@PathParam("sellerid") Integer sellerid) {
		...
		try {
	        ...
	        WebResource webResource = client
	          .resource("http://localhost:8090/SellerService/api/v2/review/getreiewwithdata/user/"+sellerid);
